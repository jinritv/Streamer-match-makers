...
const StreamersCategories = require("./streamers_categories")(
  sequelize,
  DataTypes
);
const StreamersCollabs = require("./streamers_collabs")(sequelize, DataTypes);
const StreamersLanguages = require("./streamers_languages")(
  sequelize,
  DataTypes
);
const StreamersChatVibes = require("./streamers_chat_vibes")(
  sequelize,
  DataTypes
);
const StreamersLocations = require("./streamers_locations")(
  sequelize,
  DataTypes
);
const StreamersNationalities = require("./streamers_nationalities")(
  sequelize,
  DataTypes
);
...
Streamers.belongsToMany(ChatVibes, {
  ...
  foreignKey: "streamer_id",
  otherKey: "chat_vibe_id",
});
ChatVibes.belongsToMany(Streamers, {
  through: StreamersChatVibes,
  foreignKey: "chat_vibe_id",
  otherKey: "streamer_id",
});

// streamers & locations tables
Streamers.belongsToMany(Locations, {
  through: StreamersLocations,
  foreignKey: "streamer_id",
  otherKey: "location_id",
});
Locations.belongsToMany(Streamers, {
  through: StreamersLocations,
...
Streamers.belongsToMany(Nationalities, {
  through: StreamersNationalities,
  foreignKey: "streamer_id",
  otherKey: "nationality_id",
});
Nationalities.belongsToMany(Streamers, {
  through: StreamersNationalities,
...
Streamers.belongsToMany(Tags, {
  through: StreamersTags,
  foreignKey: "streamer_id",
  otherKey: "tag_id",
});
Tags.belongsToMany(Streamers, {
  through: StreamersTags,
  foreignKey: "tag_id",
  otherKey: "streamer_id",
});
