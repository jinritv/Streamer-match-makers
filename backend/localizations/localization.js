...
const CallbackLanguageFileLoad = (callbackFileLoaded) => (err, rawdata) => {
    ...
    if (err) {
        errorMessage = "Error: could not load language .json file! Check if the filepath and names are correct. Default language set to English";
    ...
    callbackFileLoaded({AvailableLanguages: Languages.Tags, Texts: languageData, Icons: Languages.Icons, Error: errorMessage}, null)
}
